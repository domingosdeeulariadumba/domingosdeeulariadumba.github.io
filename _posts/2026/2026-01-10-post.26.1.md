...
Despite this attempt, it is also fair to mention that this separation of concerns has also mostly resulted in what we may call the data and infrastructure tension.
...
The motto here is effort and time allocation, as David also stated: if you somehow spend 80% of the time dealing with infrastructure or computing related problems instead of working on data, it should be reasonable to question whether you are a Data Scientist or a Developer.
...
There might not exist a Tukey or a Cleveland now, but we may all agree that, again, it's a new invitation to enlarge the frontiers of the field of… Data Science.
