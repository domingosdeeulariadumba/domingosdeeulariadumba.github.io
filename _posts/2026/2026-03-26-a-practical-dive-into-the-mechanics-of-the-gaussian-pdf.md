...
<div align="center">
$$\frac{d}{dx} LL = \sum_{i=1}^{n} \frac{d}{d\Phi} (\ln\Phi(\Delta_i)) \cdot \frac{d \Phi}{d\Delta_i} \cdot \frac{d \Delta_i}{dx} = 0$$
$$\frac{d}{dx} LL = \sum_{i=1}^{n} \frac{1}{\Phi(\Delta_i)} \cdot \frac{d \Phi}{d\Delta_i} \cdot (-1) = 0$$
$$\frac{d}{dx} LL = \sum_{i=1}^{n} \frac{1}{\Phi(\Delta_i)} \cdot \frac{d \Phi}{d\Delta_i} = 0 \quad [2]$$
</div>
...
$$m^2 = \frac{1}{2h^2} \implies m = \frac{1}{h\sqrt{2}}$$
</div>
